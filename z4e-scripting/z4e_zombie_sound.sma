...
new const SOUND_ZOMBIE_DEATH[][] = { "zombie_plague/zombie_die1.wav", "zombie_plague/zombie_die2.wav","zombie_plague/zombie_die3.wav","zombie_plague/zombie_die4.wav","zombie_plague/zombie_die5.wav"}
...
new const SOUND_ZOMBIE_RESPAWN[][] = { "zombie_plague/zombie_brains1.wav","zombie_plague/zombie_brains2.wav"}
new const SOUND_ZOMBIE_COMING[][] = { "zombie_plague/zombie_infec1.wav", "zombie_plague/zombie_infec2.wav","zombie_plague/zombie_infec3.wav"}
