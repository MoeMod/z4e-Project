...
public plugin_init() 
{
    ...
    /*
    server_print("[ZH] Model Precache Reserved Slots: %i", 512 - ArraySize(ArModel))
    server_print("[ZH] Sound Precache Reserved Slots: %i", 512 - ArraySize(ArSound))
    */
}
